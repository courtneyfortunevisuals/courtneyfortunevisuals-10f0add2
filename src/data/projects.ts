...
const allProjects: Project[] = [
  ...
  },
  {
    ...
    description: [
      ...
      '<a href="https://www.snapchat.com/lens/20fb6fa0d5ed42e597a7bc1a1fddbea2?sender_web_id=04efc47d-faf1-4ea3-ae07-095a6b4b9517&device_type=desktop&is_copy_url=true" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-primary hover:text-primary/80 font-medium transition-colors duration-200 group">Try the Lens <span class="inline-block transition-transform group-hover:translate-x-1">→</span></a>',
      "Open snapchat and scan QR code"
    ],
